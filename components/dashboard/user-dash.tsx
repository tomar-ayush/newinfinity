...
const potentialClientData = [
  { id: 1, name: 'Acme Corp', status: 'Pending', lastContacted: '2024-05-15', probability: '65%' },
  { id: 2, name: 'Tech Innovations', status: 'Negotiation', lastContacted: '2024-05-20', probability: '80%' },
  { id: 3, name: 'Global Solutions', status: 'Initial Contact', lastContacted: '2024-05-10', probability: '40%' },
];
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="flex items-center justify-between p-6">
            <div>
              <h3 className="text-sm text-gray-500">Email Campaigns</h3>
      ...
      {currentTab === 'overview' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-4">Top Potential Clients</h2>
      ...
      {currentTab === 'leads' && (
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold">Potential Leads Management</h2>
            <button 
          ...
          <p>Leads management section with detailed tracking and interaction history.</p>
        </div>
      )}

      {currentTab === 'campaigns' && (
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-xl font-semibold mb-4">Email Campaign Insights</h2>
          <p>Comprehensive email campaign tracking and performance analytics.</p>
        </div>
      )}
    </div>
  );
